...
def test_addowner_no_owner_perms():
    ...
    response = requests.post(f"{BASE_URL}/auth/register/v2", json=invited_member_data_2)
    response_data = response.json()
    ...
    join_info["token"] = invited_member_token_2
