...
def test_message_share_member_not_in_channel(clear, first_user_data, second_user_data):
    response = rh.channel_create(first_user_data["auth_user_id"], "channel_1", True)
    channel_1 = response.json()

    response = rh.message_send(first_user_data["auth_user_id"], channel_1, "hello")
    message_id = response.json()

    response = rh.message_share(second_user_data["auth_user_id"], message_id, None, channel_1, -1)
    
    assert response.status_code == 403

def test_message_share_member_not_in_dm(clear, first_user_data, second_user_data):
    response = rh.dm_create(first_user_data["auth_user_id"], [])
    dm_id = response.json()

    response = rh.message_senddm(first_user_data["auth_user_id"], dm_id, "hello")
    message_id = response.json()

    response = rh.message_share(second_user_data["auth_user_id"], message_id, None, -1, dm_id)
...
def test_message_share_invalid_channel_id(clear, first_user_data):
    ...
    response = rh.message_share(first_user_data["auth_user_id"], message_id, None, fake_channel_id, -1)
...
def test_message_share_invalid_dm_id(clear, first_user_data):
    ...
    response = rh.message_share(first_user_data["auth_user_id"], message_id, None, -1, fake_dm_id)
...
def test_message_share_channel_id_and_dm_id_arent_negative_1(clear, first_user_data):
    ...
    response = rh.message_share(first_user_data["auth_user_id"], message_id, None, channel_1, dm_id)
...
def test_message_share_channel_og_message_id_not_valid(clear, first_user_data):
    ...
    response = rh.message_share(first_user_data["auth_user_id"], fake_message_id, None, channel_1, -1)
...
def test_message_share_dm_og_message_id_not_valid(clear, first_user_data):
    ...
    response = rh.message_share(first_user_data["auth_user_id"], fake_message_id, None, -1, dm_id)
...
def test_message_share_length_of_message_too_long(clear, first_user_data):
    ...
    response = rh.message_share(first_user_data["auth_user_id"], message_id, long_message, channel_1, -1)
